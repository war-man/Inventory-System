    ...
    public class NetcoreService : INetcoreService
    {
        ...
        public VMStock GetStockByProductAndWarehouse(string productId, string warehouseId)
        {
            ...
            try
            {
                ...
                if (product != null && warehouse != null)
                {
                    ...
                    stock.QtyOnhand = product.Qty; // added by Hazem as a temporary hack
        ...
        public async Task InitDemo()
        {
            try
            {
                ...
                Branch branch = new Branch() { branchName = "HQ", isDefaultBranch = true, street1 = "22521 Avenida Empresa, Suite 127, Rancho Santa Margarita, CA 92688" };
                _context.Branch.Add(branch);

                List<Warehouse> whs = new List<Warehouse>() {
                    new Warehouse{warehouseName = "Rancho", branch = branch, street1 = "22521 Avenida Empresa, Suite 127, Rancho Santa Margarita, CA 92688"},
                ...
                List<Product> products = new List<Product>() {
                    new Product{productCode = "Argan", productName = "Argan", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Chang", productName = "Chang", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Aniseed Syrup", productName = "Aniseed Syrup", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Chef Anton's Cajun Seasoning", productName = "Chef Anton's Cajun Seasoning", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Chef Anton's Gumbo Mix", productName = "Chef Anton's Gumbo Mix", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Grandma's Boysenberry Spread", productName = "Grandma's Boysenberry Spread", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Uncle Bob's Organic Dried Pears", productName = "Uncle Bob's Organic Dried Pears", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Northwoods Cranberry Sauce", productName = "Northwoods Cranberry Sauce", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Mishi Kobe Niku", productName = "Mishi Kobe Niku", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Ikura", productName = "Ikura", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Queso Cabrales", productName = "Queso Cabrales", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Queso Manchego La Pastora", productName = "Queso Manchego La Pastora", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Konbu", productName = "Konbu", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Tofu", productName = "Tofu", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                    //new Product{productCode = "Genen Shouyu", productName = "Genen Shouyu", productType = ProductType.Clearly_Product, uom = UOM.Pcs},
                ...
                List<Vendor> vendors = new List<Vendor>() {
                    new Vendor{vendorName = "Buy Activated Charcoal", street1 = "PO BOX 261, Crawford, NE 69339 USA", size = BusinessSize.SMB, description ="+1-308-665-1566"},
                ...
                List<Customer> customers = new List<Customer>() {
                    new Customer{customerName = "Amazon", street1 = "Seattle, WA", size = BusinessSize.Enterprise},
